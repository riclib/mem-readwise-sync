...
func syncCraft(context Context) {
	syncBooksToCraft(context)
	syncHighlightsToCraft(context)
}

func syncHighlightsToCraft(ctx Context) {
...
func syncBooksToCraft(ctx Context) {
	books := GetBooks(ctx)
